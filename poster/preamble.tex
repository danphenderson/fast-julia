...
\usepackage[dvipsnames,svgnames]{xcolor} % unified color load
\usepackage{iftex} % <-- add this
\usepackage[font=small,labelfont=bf]{caption} % or comment this and keep poster’s caption line
\usepackage{url}
\usepackage{hyperref}
\usepackage{mdframed}
\usepackage{tikz}
...
\usepackage{times}
% \usepackage[margin=1.5cm]{geometry} % try 1.5cm or 1.0cm
\usepackage{enumitem} 
\setlist[itemize]{nosep,leftmargin=*} % removes extra vertical space in itemize
\usepackage[dvipsnames,svgnames]{xcolor}
\usepackage{todonotes}
\usepackage[T1]{fontenc}
\usepackage{tabularx}

% ---------- Page setup (skip for a0poster) ----------
\makeatletter
% A0-poster-specific tweaks
\@ifclassloaded{a0poster}{%
  \columnsep=100pt
  \columnseprule=3pt
  \graphicspath{{figures/}}
  \usepackage{times}% if you truly want Times only for the poster
}{}
\makeatother
...
\newlength{\HeaderLogoH}
\setlength{\HeaderLogoH}{6cm} % <-- tune logo height here

% --------- Code Listings ----------
\captionsetup[lstlisting]{font={small}, labelfont={bf}, labelsep=colon}
\renewcommand{\lstlistingname}{Code} % Must at top for some reason
...
% Main shared “theorem” counter per section:
