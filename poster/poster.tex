...
{\normalsize
We benchmark naïve and optimized Julia implementations
on a representative problem for small to moderate systems of (O), $\vx'(t) = \vf(\vx, t)$ with
$\dim(\vx) \leq 10^2$. We demonstrate how to assess and resolve performance 
...
\subsection*{Heap vs. Stack Allocation:} In Julia (and low-level languages like C),
